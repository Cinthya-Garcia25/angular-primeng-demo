...
const ALL_PERMISSIONS: { label: string; value: string; group: string }[] = [
  ...
  { label: 'Eliminar grupos',        value: 'group:delete',        group: 'Grupos' },
  ...
  { label: 'Cambiar estado',         value: 'ticket:edit_state',   group: 'Tickets' },
  ...
  { label: 'Eliminar usuarios',      value: 'user:delete',         group: 'Usuarios' },
