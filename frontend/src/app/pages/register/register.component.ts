// Migrado desde pages/auth/register/register.page.ts
...
@Component({
  ...
  imports: [RouterLink, ReactiveFormsModule, ButtonModule, CardModule, CheckboxModule, InputTextModule, KeyFilterModule, MessageModule, PasswordModule, ToastModule],
...
export class RegisterComponent {
  ...
  submitRegister(): void {
    if (this.registerForm.invalid) {
      ...
      this.messageService.add({ severity: 'warn', summary: 'Datos incompletos', detail: 'Corrige los errores antes de registrarte.' });
      return;
    }
    this.loading = true;
    ...
    this.authService.register({
      ...
      next: () => {
        this.messageService.add({ severity: 'success', summary: 'Registro exitoso', detail: 'Cuenta creada correctamente. Ya puedes iniciar sesion.' });
