...
export class TicketsPageComponent implements OnInit, OnDestroy {
  ...
  setQuickFilter(f: 'all' | 'mine' | 'unassigned' | 'high_priority'): void { this.activeQuickFilter = f; }
  ...
  askDeleteTicket(t: Ticket): void { this.ticketToDelete = t; this.deleteDialogVisible = true; }
